...
<?php echo $this->Form->create('User', array('enctype' => 'multipart/form-data', 'class' => 'form-data dropzone', 'id' => 'new_user_data')); ?>
	...
	<?php
			...
			echo $this->App->showForminputs(array(									
					...
					array('input' => 'email', 'label' => 'Email Address', 'class' => '', 'wrapper' => 'col-md-4 nopadding', 'clear' => 1),									
				), true);	
	?>
	</div>
	<div class="col-md-12 nopadding">
	...
	<?php
			echo $this->App->showForminputs(array(				
					...
					array('input' => 'username', 'label' => 'Username *', 'class' => '', 'wrapper' => 'col-md-3 nopadding', 'clear' => 1, 'note' => 'Username should be at least 6 alphanumeric characters and all uppercase'),
					//array('input' => 'password', 'default' => $pass, 'type' => 'password', 'label' => 'Password *', 'class' => 'letters_and_numbers', 'note' => 'Auto-generated Password ( '.$pass.' ) '),															
