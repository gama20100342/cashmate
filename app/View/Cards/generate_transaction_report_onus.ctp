<?php
	...
	fputcsv($file, array($status ." TRANSACTIONS : ON US"), "\t");
	fputcsv($file, array(""), "\t");
	...
	if(!empty($onus_purchase)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('onus_transactions', 'PROC CODE TOTAL', $onus_purchase_total_proc));
	...
	if(!empty($onus_withdrawals)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('onus_transactions', 'PROC CODE TOTAL', $onus_withdrawals_total_proc));
	...
	if(!empty($onus_billspayment)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('onus_transactions', 'PROC CODE TOTAL', $onus_billspayment_total_proc));
	...
	if(!empty($onus_changepin)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('onus_transactions', 'PROC CODE TOTAL', $onus_changepin_total_proc));
	...
	if(!empty($onus_loadcash)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('onus_transactions', 'PROC CODE TOTAL', $onus_loadcash_total_proc));
	...
	if(!empty($onus_cashout)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('onus_transactions', 'PROC CODE TOTAL', $onus_cashout_total_proc));
