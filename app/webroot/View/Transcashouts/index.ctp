...
<div class="cards view col-md-12">	
			...
			<div class="col-md-6 nopadding">
				...
				<?php 
					echo $this->App->exportButton('csv', 'transcashouts');
					echo $this->App->exportButton('print', 'transcashouts');
					...
					/*echo $this->App->ShowbuttonAjaxWithReport(
						...
						'file-pdf',
						'_pdf_res',
						$this->webroot.'transcashouts/generate_pdf_report'
					);
					...
					echo $this->App->ShowbuttonAjaxWithReport(
						...
						'file-excel',
						'_csv_res',
						$this->webroot.'transcashouts/generate_csv_report'
					);
			...
			<div class="related col-md-12 nopadding trans_content m-t-20">	
					...
					<?php echo $this->App->tHead($this->Lang->index_header('cashouts'), 'trans_balinq_'); ?>					
