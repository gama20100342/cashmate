<?php echo $this->App->CommonHeaderWithButton(
	$prd['Product']['name'].' &raquo; Add Product Annual Cycle Limit',	
	$this->App->Showbutton(
						'Back', 
...
<div class="col-md-12">
		<h3 class="text-violet nopadding">
			...
			<div class="fs-11 bold text-danger"> Annual Cycle Limit</div>
		</h3>		
...
<?php echo $this->Form->create('Cardannuallimit', array('class' => 'data-form', 'id' => 'new_limit_form')); ?>
