<?php echo $this->App->CommonHeaderWithButton(
	$prd['Product']['name'].' &raquo; Add Product Daily Cycle Limit',	
	$this->App->Showbutton(
						'Back', 
...
<div class="col-md-12">
		<h3 class="text-violet nopadding">
			...
			<div class="fs-11 bold text-danger"> Daily Cycle Limit</div>
		</h3>		
...
<?php echo $this->Form->create('Carddailylimit', array('class' => 'data-form', 'id' => 'new_limit_form')); ?>
