...
class Card extends AppModel {
	...
	public function beforeSave($options = array()){
		...
		if(empty($this->data['Card']['registration'])){
			$this->data['Card']['registration'] = date('Y-m-d h:i:s');
		}
		
		if(empty($this->data['Card']['balance'])){
			$this->data['Card']['balance'] = '0.00';
		}
		return true;
	}
/**
 ...
 */
	public $validate = array(
		...
		'cardno' => array(
			...
			'isUnique' => array(
				'rule' => array('isUnique'),
				'message' => 'Card number was already tag by other branch / merchant a whiel ago, please try again.',
				//'allowEmpty' => false,
				//'required' => false,
				//'last' => false, // Stop validation after this rule
				//'on' => 'create', // Limit validation to 'create' or 'update' operations
 ...
 */
	...
	public $hasMany = array(
		...
		'Transinterbank' => array(
			'className' => 'Transinterbank',
			'foreignKey' => 'card_id',
			'dependent' => false,
			'conditions' => '',
			'fields' => '',
