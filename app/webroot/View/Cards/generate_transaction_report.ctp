<?php
	...
	fputcsv($file, array("MAIN REPORT"), "\t");
	fputcsv($file, array(""), "\t");
	fputcsv($file, array("RUN DATE : " . date('Y-m-d h:i:s')), "\t");
	...
	if(!empty($onus_balance_inquiries)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $onus_balinq_total_proc));
	...
	if(!empty($acq_balance_inquiries)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $iss_balinq_total_proc));
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'TOTAL', number_format($total_balance_inquiry, 2, ".", ",")));
		fputcsv($file, array(""), "\t");
	}
	...
	//PURCHASE ON US
	if(!empty($onus_purchase)){
		$total_purchase = 0;
		foreach($onus_purchase as $t): 
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $onus_purchase_total_proc));
	...
	if(!empty($iss_purchase)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $iss_purchase_total_proc));
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'TOTAL', number_format($total_purchase, 2, ".", ",")));
		fputcsv($file, array(""), "\t");
	}
	//END OF PURCHASE
	...
	//CASH WITHDRAWALS ON US
	if(!empty($onus_withdrawals)){
		$total_withdrawals = 0;
		foreach($onus_withdrawals as $t): 
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $onus_withdrawals_total_proc));
	...
	if(!empty($iss_withdrawals)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $iss_withdrawals_total_proc));
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'TOTAL', number_format($total_withdrawals, 2, ".", ",")));
		fputcsv($file, array(""), "\t");
	}
	//END OF CASH WITHDRAWALS
	...
	//BILLS PAYMENT ON US
	if(!empty($onus_billspayment)){
		$total_billspayment = 0;
		foreach($onus_billspayment as $t): 
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $onus_billspayment_total_proc));
	...
	if(!empty($iss_billspayment)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $iss_billspayment_total_proc));
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'TOTAL', number_format($total_billspayment, 2, ".", ",")));
		fputcsv($file, array(""), "\t");
	}
	//END OF BILLS PAYMENT
	...
	//CHANGE PIN ON US
	if(!empty($onus_changepin)){
		$total_changepin = 0;
		foreach($onus_changepin as $t): 
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $onus_changepin_total_proc));
	...
	if(!empty($iss_changepin)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $iss_changepin_total_proc));
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'TOTAL', number_format($total_changepin, 2, ".", ",")));
		fputcsv($file, array(""), "\t");
	}
	//END OF CHANGE PIN
	...
	//CASH LOAD ON US
	if(!empty($onus_loadcash)){
		$total_cashload = 0;
		foreach($onus_loadcash as $t): 
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $onus_loadcash_total_proc));
	...
	if(!empty($iss_loadcash)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $iss_loadcash_total_proc));
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'TOTAL', number_format($total_cashload, 2, ".", ",")));
		fputcsv($file, array(""), "\t");
	}
	//END OF CASH LOAD
	...
	//CASH OUT ON US
	if(!empty($onus_cashout)){
		$total_cashout = 0;
		foreach($onus_cashout as $t): 
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $onus_cashout_total_proc));
	...
	if(!empty($iss_cashout)){
		...
		endforeach;
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'PROC CODE TOTAL', $iss_cashout_total_proc));
		fputcsv($file, $this->Lang->report_total('main_report_lower', 'TOTAL', number_format($total_cashout, 2, ".", ",")));
		fputcsv($file, array(""), "\t");
	}
	//END OF CASH OUT
