...
<?php echo $this->Form->create('Institution', array('class' => 'data-form', 'id' => 'new_institution_form')); ?>
	...
	?>
				<label class="checkbox-inline text-uppercase text-success fs-10 bold">
						<input type="checkbox" name="data[Institution][product_id][]" value="<?php echo $p['Product']['id']; ?>"><div class="m-t-3"><?php echo $p['Product']['id'] .' - '.$p['Product']['name']; ?></div>						
				</label>
				<div class="clear"></div>
	<?php 
	...
	<?php echo $this->App->formEnd('Save', '#new_institution_form'); ?>
	</div>	
	<div class="clear"></div>	
</div>
