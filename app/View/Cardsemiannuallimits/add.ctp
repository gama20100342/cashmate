<?php echo $this->App->CommonHeaderWithButton(
	$prd['Product']['name'].' &raquo; Add Product Semi-Annual Cycle Limit',	
	$this->App->Showbutton(
						'Back', 
...
<div class="col-md-12">
		<h3 class="text-violet nopadding">
			...
			<div class="fs-11 bold text-danger"> Semi-Annual Cycle Limit</div>
		</h3>		
...
<?php echo $this->Form->create('Cardsemiannuallimit', array('class' => 'data-form', 'id' => 'new_limit_form')); ?>
