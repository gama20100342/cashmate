...
<div class="cards view col-md-12">	
			...
			<div class="col-md-6 nopadding">
				<div class="btn-group pull-right">
					<?php 
						echo $this->App->exportButton('csv', 'transbalanceinquiries');
						echo $this->App->exportButton('print', 'transbalanceinquiries');
						...
						/*echo $this->App->ShowbuttonAjaxWithReport(
							...
							'file-pdf',
							'_pdf_res',
							$this->webroot.'transbalanceinquiries/generate_pdf_report'
						);
						...
						echo $this->App->ShowbuttonAjaxWithReport(
							...
							'file-excel',
							'_csv_res',
							$this->webroot.'transbalanceinquiries/generate_csv_report'
						);
...
<?php
	...
	echo $this->Js->Buffer('
		$(document).ready( function(){				
			get_transaction_data_default("'.$this->webroot.'transbalanceinquiries/getAllTransactions", "#trans_balinq_", [2, 5]);
			...
			$(".showtrans").click( function(){
				...
				if(_date_to.length !==10 || _date_from.length !==10 || _date_to <= _date_from){
					...
					get_transaction_data_default("'.$this->webroot.'transbalanceinquiries/getAllTransactions/" + _date_from + "/" + _date_to, "#trans_balinq_", [2, 5]);
				}
			})
