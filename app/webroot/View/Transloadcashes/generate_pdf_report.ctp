...
if(!empty($trans)){
	...
	foreach($trans as $key => $t):
		$html .='<tr>';
				$html .= '<td>'.$t['Transloadcash']['posimei'].'</td>';
				$html .= '<td>'.$t['Transloadcash']['cardno'].'</td>';
				$html .= '<td>'.$t['Transloadcash']['accountname'].'</td>';
				$html .= '<td>'.date('Y M d h:i A', strtotime($t['Transloadcash']['transdate'])).'</td>';																											
				$html .= '<td>'.$t['Transloadcash']['load_amount'].'</td>';
				$html .= '<td>'.$t['Transloadcash']['processed_by'].'</td>';
