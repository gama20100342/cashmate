...
if(!empty($trans)){
	...
	foreach($trans as $key => $t):
		$html .='<tr>';
				$html .= '<td>'.$t['Transcashout']['posimei'].'</td>';
				$html .= '<td>'.$t['Transcashout']['cardno'].'</td>';
				$html .= '<td>'.$t['Transcashout']['accountname'].'</td>';
				$html .= '<td>'.date('Y M d h:i A', strtotime($t['Transcashout']['transdate'])).'</td>';
				$html .= '<td>'.$t['Transcashout']['withdrawal_amount'].'</td>';
				$html .= '<td>'.$t['Transcashout']['processed_by'].'</td>';
