...
<div class="cards view col-md-12">	
			...
			<div class="col-md-6 nopadding">
				...
				<?php 
					echo $this->App->exportButton('csv', 'transchangepins');
					echo $this->App->exportButton('print', 'transchangepins');
					...
					/*echo $this->App->ShowbuttonAjaxWithReport(
						...
						'file-pdf',
						'_pdf_res',
						$this->webroot.'transchangepins/generate_pdf_report'
					);
					...
					echo $this->App->ShowbuttonAjaxWithReport(
						...
						'file-excel',
						'_csv_res',
						$this->webroot.'transchangepins/generate_csv_report'
					);
			...
			<div class="related col-md-12 nopadding trans_content m-t-20">	
					<?php echo $this->App->tHead($this->Lang->index_header('change_pin'), 'trans_balinq_'); ?>					
...
<?php
	...
	echo $this->Js->Buffer('
		$(document).ready( function(){				
			get_transaction_data_default("'.$this->webroot.'transchangepins/getAllTransactions", "#trans_balinq_", [2,5]);
			...
			$(".showtrans").click( function(){
				...
				if(_date_to.length !==10 || _date_from.length !==10 || _date_to <= _date_from){
					...
					get_transaction_data_default("'.$this->webroot.'transchangepins/getAllTransactions/" + _date_from + "/" + _date_to, "#trans_balinq_", [2,5]);
				}
			});
