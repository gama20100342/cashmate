...
<div class="cards view col-md-12">	
			...
			<div class="col-md-6 nopadding">
				...
				<?php 
					echo $this->App->exportButton('csv', 'transpurchases');
					echo $this->App->exportButton('print', 'transpurchases');
			...
			<div class="related col-md-12 nopadding trans_content m-t-20">	
					<?php echo $this->App->tHead($this->Lang->index_header('purchases'), 'trans_balinq_'); ?>					
...
<?php
	...
	echo $this->Js->Buffer('
		$(document).ready( function(){				
			get_transaction_data_default("'.$this->webroot.'transpurchases/getAllTransactions", "#trans_balinq_", [2]);
			...
			$(".showtrans").click( function(){
				...
				if(_date_to.length !==10 || _date_from.length !==10 || _date_to <= _date_from){
					...
					get_transaction_data_default("'.$this->webroot.'transpurchases/getAllTransactions/" + _date_from + "/" + _date_to, "#trans_balinq_", [2]);
				}
			});
