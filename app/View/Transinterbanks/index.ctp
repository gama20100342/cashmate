...
<div class="cards view col-md-12">	
			...
			<div class="col-md-6 nopadding">
				...
				<?php 
					echo $this->App->exportButton('csv', 'transinterbanks');
					echo $this->App->exportButton('print', 'transinterbanks');
			...
			<div class="related col-md-12 nopadding trans_content m-t-20">	
					<?php echo $this->App->tHead($this->Lang->index_header('interbank'), 'trans_balinq_'); ?>					
					<?php echo $this->App->tFFoot($this->Lang->index_header('interbank')); ?>
...
<?php
	...
	echo $this->Js->Buffer('
		$(document).ready( function(){				
			get_transaction_data_default("'.$this->webroot.'transinterbanks/getAllTransactions", "#trans_balinq_", [2]);
			...
			$(".showtrans").click( function(){
				...
				if(_date_to.length !==10 || _date_from.length !==10 || _date_to <= _date_from){
					...
					get_transaction_data_default("'.$this->webroot.'transinterbanks/getAllTransactions/" + _date_from + "/" + _date_to, "#trans_balinq_", [2]);
				}
			});
