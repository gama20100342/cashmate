...
<div class="users form col-md-12">
	<fieldset>	
			<h5 class="nopadding nomargin">Select The File to Upload</h5>
				...
				<div class="col-md-12 nopadding text-left m-t-20">
					<div id="fileuploader" class="pull-right nodisplay">Upload</div>
	...
	<button type="button" class="nodisplay m-b-20 submitpic btn btn-sm btn-success pull-right"><i class="fas fa-save fa-lg"></i> Upload & Save</button>
