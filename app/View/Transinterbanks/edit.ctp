<div class="transinterbanks form">
<?php echo $this->Form->create('Transinterbank'); ?>
	<fieldset>
		<legend><?php echo __('Edit Transinterbank'); ?></legend>
	<?php
		...
		echo $this->Form->input('deviceno');
		echo $this->Form->input('trans_cardnumber');
		echo $this->Form->input('receiving_accountno');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Transinterbank.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Transinterbank.id'))); ?></li>
