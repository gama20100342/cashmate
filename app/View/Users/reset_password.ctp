...
<?php echo $this->Form->create('User', array('enctype' => 'multipart/form-data', 'class' => 'form-data dropzone', 'id' => 'new_user_data')); ?>
	...
	<?php
			...
			echo $this->App->showForminputs(array(									
					array('input' => 'title', 'label' => 'Title *', 'type' => 'select', 'empty' => false, 'options' => $this->Lang->listofTitle(), 'wrapper' => 'col-md-1 nopadding', 'read-only' => true),
					array('input' => 'firstname', 'label' => 'First Name * ', 'class' => 'letters_only', 'wrapper' => 'col-md-3 nopadding', 'read-only' => true),
					array('input' => 'middlename', 'label' => 'Middle Name * ', 'class' => 'letters_only', 'wrapper' => 'col-md-3 nopadding', 'read-only' => true),
					array('input' => 'lastname', 'label' => 'Last Name *', 'class' => 'letters_only', 'wrapper' => 'col-md-3 nopadding', 'read-only' => true),
					array('input' => 'suffix', 'label' => 'Suffix', 'class' => 'letters_only', 'wrapper' => 'col-md-2 nopadding', 'clear' => 1, 'read-only' => true),
					array('input' => 'contact_no', 'label' => 'Mobile No. (+63) *', 'class' => 'contact_no', 'wrapper' => 'col-md-4 nopadding', 'read-only' => true),
					array('input' => 'tel_no', 'label' => 'Telephone No', 'class' => 'tel_no', 'wrapper' => 'col-md-4 nopadding', 'read-only' => true),									
					array('input' => 'email', 'label' => 'Email Address', 'class' => '', 'wrapper' => 'col-md-4 nopadding', 'clear' => 1, 'read-only' => true),									
				), true);	
	?>
	</div>
	<div class="col-md-12 nopadding">
	...
	<?php
			echo $this->App->showForminputs(array(				
					array('input' => 'group_id', 'label' => 'Access Type *', 'type' => 'select', 'options' => $groups, 'wrapper' => 'col-md-6 nopadding', 'read-only' => true),
					//array('input' => 'terminal_id', 'label' => 'Acccess Terminal *',  'class' => 'letters_only', 'type' => 'select', 'options' => $terminals, 'clear' => '1'),				
					array('input' => 'username', 'label' => 'Username *', 'class' => '', 'wrapper' => 'col-md-3 nopadding', 'note' => 'Username should be at least 6 alphanumeric characters and all uppercase', 'read-only' => true),
					array('input' => 'new_password',  'type' => 'text', 'label' => 'Password *', 'class' => 'pass_', 'wrapper' => 'col-md-3 nopadding', 'note' => 'Password should be at least 8  alphanumeric characters with one (1) special character and one ( 1 ) upper case', 'clear' => 1),															
